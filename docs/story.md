...
| T4 | นักบิดสายด่วน ⚡ | มันส์สุดขีด | 1,500–2,599 | W4 + streak ≥ 20 |
| T5 | หัวรถจักร 🚂 | ตำนาน | ≥ 2,600 | W4 + streak ≥ 35 (mult 8) |
...
|---|---|---|---|---|---|
| timeBank | เวลาคงเหลือ | 45 วิ | [0, **50**] | ถูก +wReward · ผิด −5 · milestone +6 · ไหล −1/วิ | จบเกมที่ 0 · แถบเวลา |
...
| "เด็กเทพคณิต" | W1–W4 streak 40+ mult 8 | W4: 10×4×8=320/ข้อ · ~2,700 | T5 ✓ + สถิติใหม่ ★ |
