...
6. **ปุ่ม "📖 ทบทวนร้อยละ" บนเมนู → หน้า study แยก** (user decision 2026-09-20 ผ่าน Telegram ตัวเลือก A): หน้า standalone `study/percent-01c.html` (interactive infographic จากชุดโจทย์ 01C ที่ผู้ปกครองแนบมา: อธิบายแนวคิด · ควิซจับเวลา 8:00 พร้อมเฉลยทีละ step · สุ่มโจทย์รายวัน + สตรีค ใน localStorage ของหน้าเอง `pctStudyV1` — ไม่แตะ 2 keys ของเกม) — เป็น shell link เปิดแท็บใหม่ตามแบบข้อ 0 ไม่ใช่ screen/system ใหม่ · ใช้ copy +2 คำ (44→46/60) · ไม่ขัด non-goals (static, ไร้ backend)
